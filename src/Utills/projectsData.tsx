export const projects = [
  {
    title: "Airflow Jobs Monitoring Dashboard (Team Lead)",
    image: "/images/skills/apacheairflow.svg", // Used Airflow logo for relevance
    description: "Architected a real-time dashboard using Streamlit, PostgreSQL, Docker. Integrated failure analytics and anomaly alerts, cutting resolution time by 40%. Enabled customizable SQL-based filters, performance alerts, and interactive charts.",
    link: "https://github.com/abhinavsurya1/Realtime-Jobs-Monitoring-dashboard",
  ...
  },
  {
    ...
    technologies: ["Django", "Bootstrap", "REST API", "Email Automation"],
  },
  {
    title: "HTTP URL Shortener Microservice",
    image: "/images/skills/react.svg", // Using React logo for frontend relevance
    description: "A modern, responsive React application for URL shortening with advanced features. Built with React, Node.js, and micrologging for robust analytics and monitoring.",
    link: "https://github.com/abhinavsurya1/22881A05J8",
    technologies: ["React", "Node.js", "Micrologging"],
  },
  {
    title: "Neural Network Visualisation Studio",
    image: "/images/skills/typescriptLogoDisp.svg", // Using TypeScript logo for relevance
    description: "A TypeScript-based studio for visualizing neural network architectures and operations. Provides interactive tools for exploring, building, and understanding neural networks in a visual, intuitive way.",
